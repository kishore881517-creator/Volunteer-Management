...
function AdminRegister({ onNavigate }) {
    ...
    <div className="page" style={{ maxWidth: '400px', margin: '0 auto' }}>
      ...
      <div className="card" style={{ marginTop: '2rem' }}>
        ...
        <p style={{ textAlign: 'center', marginTop: '1rem' }}>
          Already have account? <button onClick={() => onNavigate('admin-login')} style={{ background: 'none', border: 'none', color: '#3498db', textDecoration: 'none', cursor: 'pointer', padding: 0, fontSize: 'inherit' }}>Login here</button>
        </p>
      </div>
    </div>
  );
